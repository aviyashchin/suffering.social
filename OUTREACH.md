# Reader-test outreach for suffering.social

## The page

https://suffering.social/

## Three readers, three roles
...
> Could you spend two minutes on this page and tell me three things:
>
> 1. Did you understand the argument by the time you reached the calculator?
> 2. Did you actually use the calculator? (Drag any slider.)
> 3. Would you share this with anyone? Who?
>
> https://suffering.social/
>
> Honest reactions only. One-line answers are fine. Thanks.

## What we're listening for

- Did they get to the calculator? (If they bounce earlier, the lead is too long or the chart didn't land.)
- Did the courts section land? (If yes, the "twelve jurors put a number on a piece of it" frame is doing work.)
- Would they share it, and with whom? (Reveals which audience the page actually serves.)
- Anything they say is confusing, missing, or feels off.

## What we're NOT asking for

- Visual critique. We can polish forever; we need to know if the page moves minds first.
- Methodology debate. The five-slider calculator IS the methodology debate.
